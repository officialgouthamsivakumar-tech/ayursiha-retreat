...
export default async function Fab() {
  ...
  return (
    <div className="fab-group">
      <a href={`https://wa.me/${waNumber}`} target="_blank" rel="noopener noreferrer" className="fab fab--wa" aria-label="Chat on WhatsApp">
      ...
      <a href={telHref} className="fab fab--phone" aria-label="Call us">
