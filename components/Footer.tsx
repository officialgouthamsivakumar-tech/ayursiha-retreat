        ...
        <div className="ft-top">
          ...
          <div>
            ...
            <div className="ft-social">
              <a href="https://www.instagram.com/ayursiha" target="_blank" rel="noopener noreferrer" aria-label={t('social.instagram')} className="ft-social-icon">
              ...
              <a href="https://www.youtube.com/@ayursiha" target="_blank" rel="noopener noreferrer" aria-label={t('social.youtube')} className="ft-social-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
